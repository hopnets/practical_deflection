...
int InterfaceTagBaseDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    InterfaceTagBase *pp = (InterfaceTagBase *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *InterfaceTagBaseDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string InterfaceTagBaseDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool InterfaceTagBaseDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *InterfaceTagBaseDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
Register_Class(PacketInsertionControlTag)

PacketInsertionControlTag::PacketInsertionControlTag() : ::inet::TagBase()
{
}

PacketInsertionControlTag::PacketInsertionControlTag(const PacketInsertionControlTag& other) : ::inet::TagBase(other)
{
    copy(other);
}

PacketInsertionControlTag::~PacketInsertionControlTag()
{
}

PacketInsertionControlTag& PacketInsertionControlTag::operator=(const PacketInsertionControlTag& other)
{
    if (this == &other) return *this;
    ::inet::TagBase::operator=(other);
    copy(other);
...
void PacketInsertionControlTag::copy(const PacketInsertionControlTag& other)
{
    this->insert_packet_without_checking_the_queue = other.insert_packet_without_checking_the_queue;
}

void PacketInsertionControlTag::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::TagBase::parsimPack(b);
    doParsimPacking(b,this->insert_packet_without_checking_the_queue);
}

void PacketInsertionControlTag::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::TagBase::parsimUnpack(b);
    doParsimUnpacking(b,this->insert_packet_without_checking_the_queue);
}

bool PacketInsertionControlTag::getInsert_packet_without_checking_the_queue() const
{
    return this->insert_packet_without_checking_the_queue;
}

void PacketInsertionControlTag::setInsert_packet_without_checking_the_queue(bool insert_packet_without_checking_the_queue)
{
    this->insert_packet_without_checking_the_queue = insert_packet_without_checking_the_queue;
}

class PacketInsertionControlTagDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
    enum FieldConstants {
        FIELD_insert_packet_without_checking_the_queue,
    };
  public:
    PacketInsertionControlTagDescriptor();
    virtual ~PacketInsertionControlTagDescriptor();
...
Register_ClassDescriptor(PacketInsertionControlTagDescriptor)

PacketInsertionControlTagDescriptor::PacketInsertionControlTagDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::PacketInsertionControlTag)), "inet::TagBase")
{
    propertynames = nullptr;
}

PacketInsertionControlTagDescriptor::~PacketInsertionControlTagDescriptor()
{
    delete[] propertynames;
}

bool PacketInsertionControlTagDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<PacketInsertionControlTag *>(obj)!=nullptr;
}

const char **PacketInsertionControlTagDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *PacketInsertionControlTagDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int PacketInsertionControlTagDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount() : 1;
}

unsigned int PacketInsertionControlTagDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_insert_packet_without_checking_the_queue
    };
    return (field >= 0 && field < 1) ? fieldTypeFlags[field] : 0;
}

const char *PacketInsertionControlTagDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    static const char *fieldNames[] = {
        "insert_packet_without_checking_the_queue",
    };
    return (field >= 0 && field < 1) ? fieldNames[field] : nullptr;
}

int PacketInsertionControlTagDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'i' && strcmp(fieldName, "insert_packet_without_checking_the_queue") == 0) return base+0;
    return basedesc ? basedesc->findField(fieldName) : -1;
}

const char *PacketInsertionControlTagDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    static const char *fieldTypeStrings[] = {
        "bool",    // FIELD_insert_packet_without_checking_the_queue
    };
    return (field >= 0 && field < 1) ? fieldTypeStrings[field] : nullptr;
}

const char **PacketInsertionControlTagDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *PacketInsertionControlTagDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int PacketInsertionControlTagDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketInsertionControlTag *pp = (PacketInsertionControlTag *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *PacketInsertionControlTagDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string PacketInsertionControlTagDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketInsertionControlTag *pp = (PacketInsertionControlTag *)object; (void)pp;
    switch (field) {
        case FIELD_insert_packet_without_checking_the_queue: return bool2string(pp->getInsert_packet_without_checking_the_queue());
        default: return "";
    }
}

bool PacketInsertionControlTagDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PacketInsertionControlTag *pp = (PacketInsertionControlTag *)object; (void)pp;
    switch (field) {
        case FIELD_insert_packet_without_checking_the_queue: pp->setInsert_packet_without_checking_the_queue(string2bool(value)); return true;
        default: return false;
    }
}

const char *PacketInsertionControlTagDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *PacketInsertionControlTagDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int InterfaceReqDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    InterfaceReq *pp = (InterfaceReq *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *InterfaceReqDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string InterfaceReqDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool InterfaceReqDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *InterfaceReqDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int InterfaceIndDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    InterfaceInd *pp = (InterfaceInd *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *InterfaceIndDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string InterfaceIndDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool InterfaceIndDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *InterfaceIndDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
