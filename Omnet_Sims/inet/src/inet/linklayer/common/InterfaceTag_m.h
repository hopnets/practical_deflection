...
/**
 * Class generated from <tt>inet/linklayer/common/InterfaceTag.msg:16</tt> by nedtool.
 * <pre>
...
class INET_API PacketInsertionControlTag : public ::inet::TagBase
{
  ...
  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const PacketInsertionControlTag&);
...
/**
 * Class generated from <tt>inet/linklayer/common/InterfaceTag.msg:31</tt> by nedtool.
 * <pre>
 * //
