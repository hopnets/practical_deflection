...
class INET_API TcpAlgorithm : public cObject
{
  ...
  public:
     ...
     */
    virtual void rttMeasurementCompleteUsingTS(simtime_t echoedTS) = 0;

    // Bolt

    virtual void receivedSrc(Packet *packet, const Ptr<const TcpHeader>& tcpseg) {throw cRuntimeError("receivedSrc called!");}
    virtual bool is_bolt() {return false;}
};
