...
void TcpConnection::sendAck(simtime_t receive_time_to_be_echoed, unsigned int hop_count_to_be_echoed)
{
    ...
    EV << "SWIFT: sendAck: Setting the hop_count to be echoed to " << hop_count_to_be_echoed - 1 << endl;
    tcpseg->setRcvd_time_to_be_echod(receive_time_to_be_echoed);
    tcpseg->setHop_count_to_be_echoed(hop_count_to_be_echoed - 1);  // -1 is for the last link it passed to reach the destination, hop# is the number of switches
