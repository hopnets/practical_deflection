...
#ifndef __INET_RANDOMHOSTETHERMACBASE_H
#define __INET_RANDOMHOSTETHERMACBASE_H
 ...
 */
class INET_API RandomHostEtherMacBase : public RandomHostMacProtocolBase
{
  public:
  ...
  public:
    RandomHostEtherMacBase();
    virtual ~RandomHostEtherMacBase();
