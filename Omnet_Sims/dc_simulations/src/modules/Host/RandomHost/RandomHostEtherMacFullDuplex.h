...
#ifndef __INET_RANDOMHOSTETHERMACFULLDUPLEX_H
#define __INET_RANDOMHOSTETHERMACFULLDUPLEX_H
 ...
 */
class INET_API RandomHostEtherMacFullDuplex : public RandomHostEtherMacBase
{
  public:
    RandomHostEtherMacFullDuplex();
  ...
  protected:
    ...
    virtual void processMsgFromNetwork(inet::EthernetSignal *signal);
