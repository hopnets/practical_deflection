...
#ifndef __INET_V2PIFOCLASSIFIER_H
#define __INET_V2PIFOCLASSIFIER_H

#include "inet/queueing/base/PacketClassifierBase.h"

#define NORMAL_PACKET 1
#define DROPPED_PACKET_HEADER 0
 ...
 * - others
 */
class INET_API V2PIFOClassifier : public queueing::PacketClassifierBase
{
  public:
    /**
