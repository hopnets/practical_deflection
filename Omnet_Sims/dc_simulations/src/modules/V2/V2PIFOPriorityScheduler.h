...
#ifndef __INET_V2PIFOPRIORITYSCHEDULER_H
#define __INET_V2PIFOPRIORITYSCHEDULER_H

#include "inet/queueing/base/PacketSchedulerBase.h"
#include "inet/queueing/contract/IPacketCollection.h"

#define DROPPED_PACKET_HEADER_QUEUE 0
#define NORMAL_QUEUE 1

using namespace inet;
using namespace queueing;

class INET_API V2PIFOPriorityScheduler : public PacketSchedulerBase, public IPacketCollection
{
  protected:
...
#endif // ifndef __INET_V2PIFOPRIORITYSCHEDULER_H
