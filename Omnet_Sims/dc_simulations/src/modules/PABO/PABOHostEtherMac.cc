...
Define_Module(PABOHostEtherMac);

simsignal_t PABOHostEtherMac::collisionSignal = registerSignal("collision");
simsignal_t PABOHostEtherMac::backoffSlotsGeneratedSignal = registerSignal("backoffSlotsGenerated");
simsignal_t PABOHostEtherMac::packetHopCountSignal = registerSignal("packetHopCount");

PABOHostEtherMac::~PABOHostEtherMac()
{
...
void PABOHostEtherMac::initialize(int stage)
{
    PABOHostEtherMacBase::initialize(stage);
...
void PABOHostEtherMac::initializeStatistics()
{
    PABOHostEtherMacBase::initializeStatistics();
...
void PABOHostEtherMac::initializeFlags()
{
    PABOHostEtherMacBase::initializeFlags();
...
void PABOHostEtherMac::processConnectDisconnect()
{
    if (!connected) {
        delete frameBeingReceived;
    ...
    PABOHostEtherMacBase::processConnectDisconnect();
...
void PABOHostEtherMac::readChannelParameters(bool errorWhenAsymmetric)
{
    PABOHostEtherMacBase::readChannelParameters(errorWhenAsymmetric);
...
void PABOHostEtherMac::handleSelfMessage(cMessage *msg)
{
...
void PABOHostEtherMac::handleMessageWhenUp(cMessage *msg)
{
    if (channelsDiffer)
...
void PABOHostEtherMac::handleUpperPacket(Packet *packet)
{
...
void PABOHostEtherMac::addReceptionInReconnectState(long packetTreeId, simtime_t endRxTime)
{
...
void PABOHostEtherMac::addReception(simtime_t endRxTime)
{
...
void PABOHostEtherMac::processReceivedJam(EthernetJamSignal *jam)
{
...
void PABOHostEtherMac::processJamSignalFromNetwork(EthernetSignal *msg)
{
...
void PABOHostEtherMac::processMsgFromNetwork(EthernetSignal *signal)
{
...
void PABOHostEtherMac::processDetectedCollision()
{
...
void PABOHostEtherMac::handleEndIFGPeriod()
{
    ...
    EV_DETAIL << "IFG elapsed in PABOHostEtherMac\n";
...
B PABOHostEtherMac::calculateMinFrameLength()
{
...
B PABOHostEtherMac::calculatePaddedFrameLength(Packet *frame)
{
    B minFrameLength = calculateMinFrameLength();
    return std::max(minFrameLength, B(frame->getDataLength()));
}

void PABOHostEtherMac::startFrameTransmission()
{
...
void PABOHostEtherMac::handleEndTxPeriod()
{
...
void PABOHostEtherMac::scheduleEndRxPeriod(EthernetSignal *frame)
{
...
void PABOHostEtherMac::handleEndRxPeriod()
{
    simtime_t dt = simTime() - channelBusySince;
...
void PABOHostEtherMac::handleEndBackoffPeriod()
{
...
void PABOHostEtherMac::sendJamSignal()
{
...
void PABOHostEtherMac::handleEndJammingPeriod()
{
...
void PABOHostEtherMac::handleRetransmission()
{
...
void PABOHostEtherMac::printState()
{
...
void PABOHostEtherMac::finish()
{
    PABOHostEtherMacBase::finish();
...
void PABOHostEtherMac::handleEndPausePeriod()
{
...
void PABOHostEtherMac::frameReceptionComplete()
{
...
void PABOHostEtherMac::processReceivedDataFrame(Packet *packet)
{
    // statistics
...
void PABOHostEtherMac::processReceivedControlFrame(Packet *packet)
{
...
void PABOHostEtherMac::scheduleEndIFGPeriod()
{
...
void PABOHostEtherMac::fillIFGIfInBurst()
{
    if (!frameBursting)
        return;
...
void PABOHostEtherMac::scheduleEndTxPeriod(B sentFrameByteLength)
{
...
void PABOHostEtherMac::scheduleEndPausePeriod(int pauseUnits)
{
...
void PABOHostEtherMac::beginSendFrames()
{
    if (currentTxFrame) {
