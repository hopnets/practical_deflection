...
#ifndef __INET_PABOHOSTETHERMAC_H
#define __INET_PABOHOSTETHERMAC_H
 ...
 */
class INET_API PABOHostEtherMac : public PABOHostEtherMacBase
{
  public:
    PABOHostEtherMac() {}
    virtual ~PABOHostEtherMac();
...
#endif // ifndef __INET_PABOHOSTETHERMAC_H
