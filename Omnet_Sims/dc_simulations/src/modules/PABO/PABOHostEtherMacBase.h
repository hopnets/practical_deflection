...
#ifndef __INET_PABOHOSTETHERMACBASE_H
#define __INET_PABOHOSTETHERMACBASE_H
 ...
 */
class INET_API PABOHostEtherMacBase : public MacProtocolBase
{
  public:
  ...
  public:
    PABOHostEtherMacBase();
    virtual ~PABOHostEtherMacBase();
