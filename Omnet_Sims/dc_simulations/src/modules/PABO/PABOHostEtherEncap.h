...
#ifndef __INET_PABOHOSTETHERENCAP_H
#define __INET_PABOHOSTETHERENCAP_H
 ...
 */
class INET_API PABOHostEtherEncap : public Ieee8022Llc
{
  protected:
...
#endif // ifndef __INET_PABOHostETHERENCAP_H
