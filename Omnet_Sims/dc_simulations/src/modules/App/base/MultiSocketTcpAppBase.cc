...
void MultiSocketTcpAppBase::connect(int dest_server_idx, int connect_port, bool is_bursty,
...
void MultiSocketTcpAppBase::socketClosed(TcpSocket *socket)
{
    // *redefine* to start another session etc.
    EV_INFO << "connection closed\n";
}

void MultiSocketTcpAppBase::socketFailure(TcpSocket *socket, int code)
{
