...
FAT_TREE = 1
TOPOLOGY = LEAF_SPINE
CATEGORIES = ["swift_ecmp", "swift_sd", "swift_dibs", "swift_vertigo", "swift_quantile_pd", "swift_dist_pd"]
...
'''
directory = './results_50_bg_dqps_swift/REQUEST_SENT/'
directory2 = './results_50_bg_dqps_swift/FLOW_STARTED/'
directory3 = './results_50_bg_dqps_swift/FLOW_ENDED/'
directory4 = './results_50_bg_dqps_swift/REPLY_LENGTH_ASKED/'
directory5 = './results_50_bg_dqps_swift/FLOW_ENDED_QUERY_ID/'
