...
'''
directory = './results_50_bg_dqps_tcp/REQUEST_SENT/'
directory2 = './results_50_bg_dqps_tcp/FLOW_STARTED/'
directory3 = './results_50_bg_dqps_tcp/FLOW_ENDED/'
directory4 = './results_50_bg_dqps_tcp/REPLY_LENGTH_ASKED/'
directory5 = './results_50_bg_dqps_tcp/FLOW_ENDED_QUERY_ID/'
...
plt.savefig("figs/{}.png".format('mean_qct_tcp'))
plt.close()

plot_figs(x_values, all_tail_qct, CATEGORIES, markers, colors)
plt.xlabel('Load (%)')
plt.ylabel('Tail QCT (s)')
plt.savefig("figs/{}.png".format('tail_qct_tcp'))
plt.close()
