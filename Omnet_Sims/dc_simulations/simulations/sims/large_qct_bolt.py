...
FAT_TREE = 1
TOPOLOGY = LEAF_SPINE
CATEGORIES = ["bolt_ecmp", "bolt_sd", "bolt_dibs", "bolt_vertigo", "bolt_quantile_pd", "bolt_dist_pd"]
...
'''
directory = './results_50_bg_dqps_bolt/REQUEST_SENT/'
directory2 = './results_50_bg_dqps_bolt/FLOW_STARTED/'
directory3 = './results_50_bg_dqps_bolt/FLOW_ENDED/'
directory4 = './results_50_bg_dqps_bolt/REPLY_LENGTH_ASKED/'
directory5 = './results_50_bg_dqps_bolt/FLOW_ENDED_QUERY_ID/'
...
plt.savefig("figs/{}.png".format('mean_qct_bolt'))
plt.close()

plot_figs(x_values, all_tail_qct, CATEGORIES, markers, colors)
plt.xlabel('Load (%)')
plt.ylabel('Tail QCT (s)')
plt.savefig("figs/{}.png".format('tail_qct_bolt'))
plt.close()
