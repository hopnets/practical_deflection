...
void parse_options(bf_switchd_context_t *ctx, int argc, char **argv, struct options *opt)
{
	...
	opt->master_mode = MASTER_MODE_PD;
    if (mode)
    {
        ...
        if (strcmp(mode, "PD") == 0)
			...
			opt->master_mode = MASTER_MODE_SWITCH;
		else
...
bf_status_t cp_run(bf_switchd_context_t *ctx, struct options *opt)
{
	...
	uint32_t switch_get_flow_priority_entries = 0;
	std::string *switch_get_flow_priority_entries_array_keys1, *switch_get_flow_priority_entries_array_keys2;
	uint64_t *switch_get_flow_priority_entries_array_prios;

	uint32_t switch_get_ig_queue_length_table_0_entries = 0;
	uint32_t switch_deflect_get_ig_queue_length_table_0_entries = 0;
	uint16_t *switch_get_ig_queue_length_table_0_qid;
	uint16_t *switch_get_ig_queue_length_table_0_rand_ports;
	uint64_t *switch_get_ig_queue_length_table_0_indices;
	uint16_t *switch_deflect_get_ig_queue_length_table_0_qid;
	uint16_t *switch_deflect_get_ig_queue_length_table_0_rand_ports;
	uint64_t *switch_deflect_get_ig_queue_length_table_0_indices;

	uint32_t switch_get_fw_idx_port_table_entries = 0;
	std::string *switch_get_fw_idx_port_table_keys;
	u_int64_t *switch_get_fw_idx_port_table_ports;

	uint32_t switch_deflect_get_fw_idx_port_table_entries = 0;
	std::string *switch_deflect_get_fw_idx_port_table_keys;
	u_int64_t *switch_deflect_get_fw_idx_port_table_ports;
	...
	uint16_t *switch_set_ig_queue_length_table_0_rand_ports, *switch_set_ig_queue_length_table_1_rand_ports;
	uint64_t *switch_set_ig_queue_length_table_0_indices, *switch_set_ig_queue_length_table_1_indices;

	uint32_t switch_deflect_get_port_0_idx_table_entries = 0, switch_get_port_0_idx_table_entries = 0;
	uint64_t *switch_deflect_get_port_0_idx_table_prefix_ids, *switch_get_port_0_idx_table_prefix_ids;
	uint64_t *switch_deflect_get_port_0_idx_table_group_ids, *switch_get_port_0_idx_table_group_ids;

	uint32_t switch_set_eg_queue_length_table_entries = 0;
	uint16_t *switch_set_eg_queue_length_table_qid;
	uint16_t *switch_set_eg_queue_length_table_rand_ports;
	...
	uint16_t *switch_get_eg_queue_length_table_rand_ports;
	uint64_t *switch_get_eg_queue_length_table_indices;

	uint32_t switch_default_routing_entries;
	...
	u_int32_t fns1_get_flow_priority_entries = 10, fns2_get_flow_priority_entries = 10;
	std::string fns1_get_flow_priority_entries_array_keys1[fns1_get_flow_priority_entries] = {"10.2.2.3", "10.2.2.5", "10.2.2.101", "10.2.2.6", "10.2.2.6", "10.2.2.6", "10.2.2.9", "10.2.2.6", "10.2.2.3", "10.2.2.5"};
	std::string fns1_get_flow_priority_entries_array_keys2[fns1_get_flow_priority_entries] = {"10.2.2.6", "10.2.2.6", "10.2.2.6", "10.2.2.3", "10.2.2.5", "10.2.2.101", "10.2.2.6", "10.2.2.9", "10.2.2.5", "10.2.2.3"};
	u_int64_t fns1_get_flow_priority_entries_array_prios[fns1_get_flow_priority_entries] = {1, 2, 1, 1, 2, 1, 1, 1, 1, 1};
	std::string fns2_get_flow_priority_entries_array_keys1[fns2_get_flow_priority_entries] = {"10.2.2.3", "10.2.2.5", "10.2.2.101", "10.2.2.6", "10.2.2.6", "10.2.2.6", "10.2.2.9", "10.2.2.6", "10.2.2.3", "10.2.2.5"};
	std::string fns2_get_flow_priority_entries_array_keys2[fns2_get_flow_priority_entries] = {"10.2.2.6", "10.2.2.6", "10.2.2.6", "10.2.2.3", "10.2.2.5", "10.2.2.101", "10.2.2.6", "10.2.2.9", "10.2.2.5", "10.2.2.3"};
	u_int64_t fns2_get_flow_priority_entries_array_prios[fns2_get_flow_priority_entries] = {1, 2, 1, 1, 2, 1, 1, 1, 1, 1};

	// get_fw_idx_port_table
	uint32_t fns1_get_fw_idx_port_table_entries = 5, fns2_get_fw_idx_port_table_entries = 5;
	std::string fns1_get_fw_idx_port_table_keys[fns1_get_fw_idx_port_table_entries] = {"10.2.2.3", "10.2.2.5", "10.2.2.6", "10.2.2.9", "10.2.2.101"};
	u_int64_t fns1_get_fw_idx_port_table_ports[fns1_get_fw_idx_port_table_entries] = {128, 144, 160, 140, 140};
	std::string fns2_get_fw_idx_port_table_keys[fns2_get_fw_idx_port_table_entries] = {"10.2.2.3", "10.2.2.5", "10.2.2.6", "10.2.2.9", "10.2.2.101"};
	u_int64_t fns2_get_fw_idx_port_table_ports[fns2_get_fw_idx_port_table_entries] = {136, 136, 136, 180, 180};

	// deflect_get_fw_idx_port_table
	uint32_t fns1_deflect_get_fw_idx_port_table_entries = 5, fns2_deflect_get_fw_idx_port_table_entries = 5;
	std::string fns1_deflect_get_fw_idx_port_table_keys[fns1_deflect_get_fw_idx_port_table_entries] = {"10.2.2.3", "10.2.2.5", "10.2.2.6", "10.2.2.9", "10.2.2.101"};
	u_int64_t fns1_deflect_get_fw_idx_port_table_ports[fns1_deflect_get_fw_idx_port_table_entries] = {140, 140, 140, 140, 140};
	std::string fns2_deflect_get_fw_idx_port_table_keys[fns2_deflect_get_fw_idx_port_table_entries] = {"10.2.2.3", "10.2.2.5", "10.2.2.6", "10.2.2.9", "10.2.2.101"};
	u_int64_t fns2_deflect_get_fw_idx_port_table_ports[fns2_deflect_get_fw_idx_port_table_entries] = {136, 136, 136, 136, 136};

	// get_ig_queue_length_table_0
	u_int32_t fns1_get_ig_queue_length_table_0_entries = 5, fns2_get_ig_queue_length_table_0_entries = 2;
	uint16_t fns1_get_ig_queue_length_table_0_qid[fns1_get_ig_queue_length_table_0_entries] = {0, 0, 0, 0, 0};
	uint16_t fns1_get_ig_queue_length_table_0_rand_ports[fns1_get_ig_queue_length_table_0_entries] = {128, 144, 160, 176, 140};
	uint64_t fns1_get_ig_queue_length_table_0_indices[fns1_get_ig_queue_length_table_0_entries] = {0, 1, 2, 3, 4};
	uint16_t fns2_get_ig_queue_length_table_0_qid[fns2_get_ig_queue_length_table_0_entries] = {0, 0};
	uint16_t fns2_get_ig_queue_length_table_0_rand_ports[fns2_get_ig_queue_length_table_0_entries] = {136, 180};
	uint64_t fns2_get_ig_queue_length_table_0_indices[fns2_get_ig_queue_length_table_0_entries] = {0, 1};
	// deflect_get_ig_queue_length_table_0
	u_int32_t fns1_deflect_get_ig_queue_length_table_0_entries = 5, fns2_deflect_get_ig_queue_length_table_0_entries = 2;
	uint16_t fns1_deflect_get_ig_queue_length_table_0_qid[fns1_deflect_get_ig_queue_length_table_0_entries] = {0, 0, 0, 0, 0};
	uint16_t fns1_deflect_get_ig_queue_length_table_0_rand_ports[fns1_deflect_get_ig_queue_length_table_0_entries] = {128, 144, 160, 176, 140};
	uint64_t fns1_deflect_get_ig_queue_length_table_0_indices[fns1_deflect_get_ig_queue_length_table_0_entries] = {0, 1, 2, 3, 4};
	uint16_t fns2_deflect_get_ig_queue_length_table_0_qid[fns2_deflect_get_ig_queue_length_table_0_entries] = {0, 0};
	uint16_t fns2_deflect_get_ig_queue_length_table_0_rand_ports[fns2_deflect_get_ig_queue_length_table_0_entries] = {136, 180};
	uint64_t fns2_deflect_get_ig_queue_length_table_0_indices[fns2_deflect_get_ig_queue_length_table_0_entries] = {0, 1};
	// todo: check
	...
	uint16_t fns1_set_ig_queue_length_table_0_rand_ports[fns1_set_ig_queue_length_table_0_entries] = {128, 144, 160, 176, 140};
	...
	uint16_t fns2_set_ig_queue_length_table_0_rand_ports[fns2_set_ig_queue_length_table_0_entries] = {136, 180};	
	...
	uint16_t fns1_set_ig_queue_length_table_1_rand_ports[fns1_set_ig_queue_length_table_1_entries] = {128, 144, 160, 176, 140};
	...
	uint16_t fns2_set_ig_queue_length_table_1_rand_ports[fns2_set_ig_queue_length_table_1_entries] = {136, 180};
	...
	if(strcmp(opt->hostname, "fns1") == 0)
	{
		...
		switch_get_ig_queue_length_table_0_entries = fns1_get_ig_queue_length_table_0_entries;
		switch_get_ig_queue_length_table_0_qid = fns1_get_ig_queue_length_table_0_qid;
		switch_get_ig_queue_length_table_0_rand_ports = fns1_get_ig_queue_length_table_0_rand_ports;
		switch_get_ig_queue_length_table_0_indices = fns1_get_ig_queue_length_table_0_indices;
		switch_deflect_get_ig_queue_length_table_0_entries = fns1_deflect_get_ig_queue_length_table_0_entries;
		switch_deflect_get_ig_queue_length_table_0_qid = fns1_deflect_get_ig_queue_length_table_0_qid;
		switch_deflect_get_ig_queue_length_table_0_rand_ports = fns1_deflect_get_ig_queue_length_table_0_rand_ports;
		switch_deflect_get_ig_queue_length_table_0_indices = fns1_deflect_get_ig_queue_length_table_0_indices;

		switch_get_fw_idx_port_table_entries = fns1_get_fw_idx_port_table_entries;
		switch_get_fw_idx_port_table_keys = fns1_get_fw_idx_port_table_keys;
		switch_get_fw_idx_port_table_ports = fns1_get_fw_idx_port_table_ports;
		switch_deflect_get_fw_idx_port_table_entries = fns1_deflect_get_fw_idx_port_table_entries;
		switch_deflect_get_fw_idx_port_table_keys = fns1_deflect_get_fw_idx_port_table_keys;
		switch_deflect_get_fw_idx_port_table_ports = fns1_deflect_get_fw_idx_port_table_ports;
		...
		switch_set_ig_queue_length_table_0_rand_ports = fns1_set_ig_queue_length_table_0_rand_ports;
		switch_set_ig_queue_length_table_1_rand_ports = fns1_set_ig_queue_length_table_1_rand_ports;
		...
		switch_set_eg_queue_length_table_rand_ports = fns1_set_eg_queue_length_table_rand_ports;
		...
		switch_get_eg_queue_length_table_rand_ports = fns1_get_eg_queue_length_table_rand_ports;
	...
	else if(strcmp(opt->hostname, "fns2") == 0)
	{
		...
		switch_get_ig_queue_length_table_0_entries = fns2_get_ig_queue_length_table_0_entries;
		switch_get_ig_queue_length_table_0_qid = fns2_get_ig_queue_length_table_0_qid;
		switch_get_ig_queue_length_table_0_rand_ports = fns2_get_ig_queue_length_table_0_rand_ports;
		switch_get_ig_queue_length_table_0_indices = fns2_get_ig_queue_length_table_0_indices;
		switch_deflect_get_ig_queue_length_table_0_entries = fns2_deflect_get_ig_queue_length_table_0_entries;
		switch_deflect_get_ig_queue_length_table_0_qid = fns2_deflect_get_ig_queue_length_table_0_qid;
		switch_deflect_get_ig_queue_length_table_0_rand_ports = fns2_deflect_get_ig_queue_length_table_0_rand_ports;
		switch_deflect_get_ig_queue_length_table_0_indices = fns2_deflect_get_ig_queue_length_table_0_indices;

		switch_get_fw_idx_port_table_entries = fns2_get_fw_idx_port_table_entries;
		switch_get_fw_idx_port_table_keys = fns2_get_fw_idx_port_table_keys;
		switch_get_fw_idx_port_table_ports = fns2_get_fw_idx_port_table_ports;
		switch_deflect_get_fw_idx_port_table_entries = fns2_deflect_get_fw_idx_port_table_entries;
		switch_deflect_get_fw_idx_port_table_keys = fns2_deflect_get_fw_idx_port_table_keys;
		switch_deflect_get_fw_idx_port_table_ports = fns2_deflect_get_fw_idx_port_table_ports;
		...
		switch_set_ig_queue_length_table_0_rand_ports = fns2_set_ig_queue_length_table_0_rand_ports;
		switch_set_ig_queue_length_table_1_rand_ports = fns2_set_ig_queue_length_table_1_rand_ports;
		...
		switch_set_eg_queue_length_table_rand_ports = fns2_set_eg_queue_length_table_rand_ports;
		...
		switch_get_eg_queue_length_table_rand_ports = fns2_get_eg_queue_length_table_rand_ports;
	...
	////////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////
    std::cout << "Populating get_fw_idx_port_table entries:" << std::endl;
	...
	bf_status = ing_table->dataAllocate(action_id, &table_data);
	assert(bf_status == BF_SUCCESS);
	for(tbl_entry=0; tbl_entry < switch_get_fw_idx_port_table_entries; tbl_entry++)
	{
		inet_pton(AF_INET, switch_get_fw_idx_port_table_keys[tbl_entry].c_str(), &ip_addr);
		printf("Coverted IP addr value = %x\n", ntohl(ip_addr));
		bf_status = table_key->setValue(0x01, ntohl(ip_addr));
		assert(bf_status == BF_SUCCESS);
		bf_status = table_data->setValue(1, switch_get_fw_idx_port_table_ports[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
		bf_status = ing_table->tableEntryAdd(*session, dev_tgt, *table_key, *table_data);
		assert(bf_status == BF_SUCCESS);
	}
    std::cout << "get_fw_idx_port_table entries added." << std::endl;
	////////////////////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////
    std::cout << "Populating deflect_get_fw_idx_port_table entries:" << std::endl;
	...
	bf_status = ing_table->dataAllocate(action_id, &table_data);
	assert(bf_status == BF_SUCCESS);
	for(tbl_entry=0; tbl_entry < switch_deflect_get_fw_idx_port_table_entries; tbl_entry++)
	{
		inet_pton(AF_INET, switch_deflect_get_fw_idx_port_table_keys[tbl_entry].c_str(), &ip_addr);
		printf("Coverted IP addr value = %x\n", ntohl(ip_addr));
		bf_status = table_key->setValue(0x01, ntohl(ip_addr));
		assert(bf_status == BF_SUCCESS);
		bf_status = table_data->setValue(1, switch_deflect_get_fw_idx_port_table_ports[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
		bf_status = ing_table->tableEntryAdd(*session, dev_tgt, *table_key, *table_data);
		assert(bf_status == BF_SUCCESS);
	}
    std::cout << "deflect_get_fw_idx_port_table entries added." << std::endl;
	////////////////////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////
	...
	bf_status = ing_table->dataAllocate(action_id, &table_data);
	assert(bf_status == BF_SUCCESS);
	for(tbl_entry=0; tbl_entry < switch_get_ig_queue_length_table_0_entries; tbl_entry++)
	{
		bf_status = table_key->setValue(0x02, switch_get_ig_queue_length_table_0_qid[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
		bf_status = table_key->setValue(0x01, switch_get_ig_queue_length_table_0_rand_ports[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
		bf_status = table_data->setValue(1, switch_get_ig_queue_length_table_0_indices[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
		bf_status = ing_table->tableEntryAdd(*session, dev_tgt, *table_key, *table_data);
		assert(bf_status == BF_SUCCESS);
	}
	...
	bf_status = ing_table->dataAllocate(action_id, &table_data);
	assert(bf_status == BF_SUCCESS);
	for(tbl_entry=0; tbl_entry < switch_deflect_get_ig_queue_length_table_0_entries; tbl_entry++)
	{
		bf_status = table_key->setValue(0x02, switch_deflect_get_ig_queue_length_table_0_qid[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
		bf_status = table_key->setValue(0x01, switch_deflect_get_ig_queue_length_table_0_rand_ports[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
		bf_status = table_data->setValue(1, switch_deflect_get_ig_queue_length_table_0_indices[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
		bf_status = ing_table->tableEntryAdd(*session, dev_tgt, *table_key, *table_data);
		assert(bf_status == BF_SUCCESS);
	}
	...
	for(tbl_entry=0; tbl_entry < switch_set_ig_queue_length_table_0_entries; tbl_entry++)
	{
		...
		assert(bf_status == BF_SUCCESS);
		bf_status = table_key->setValue(0x01, switch_set_ig_queue_length_table_0_rand_ports[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
	...
	for(tbl_entry=0; tbl_entry < switch_set_ig_queue_length_table_1_entries; tbl_entry++)
	{
		...
		assert(bf_status == BF_SUCCESS);
		bf_status = table_key->setValue(0x01, switch_set_ig_queue_length_table_1_rand_ports[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
	...
	for(tbl_entry=0; tbl_entry < switch_set_eg_queue_length_table_entries; tbl_entry++)
	{
		...
		assert(bf_status == BF_SUCCESS);
		bf_status = table_key->setValue(0x01, switch_set_eg_queue_length_table_rand_ports[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
	...
	for(tbl_entry=0; tbl_entry < switch_get_eg_queue_length_table_entries; tbl_entry++)
	{
		...
		assert(bf_status == BF_SUCCESS);
		bf_status = table_key->setValue(0x01, switch_get_eg_queue_length_table_rand_ports[tbl_entry]);
		assert(bf_status == BF_SUCCESS);
